...
namespace ZTP.ViewModel
{
    ...
    public class MainViewModel : BaseViewModel
    {
        ...
        object _SelectedPlayer1;
        public object SelectedPlayer1
        {
            get
            {
            ...
            set
            {
                if (_SelectedPlayer1 != value)
                {
                    _SelectedPlayer1 = value;
                    RaisePropertyChanged("SelectedPlayer1");
                }
            }
        }
        ...
        object _SelectedMatch1;
        public object SelectedMatch1
        {
            get
            {
                return _SelectedMatch1;
            }
            set
            {
                if (_SelectedMatch1 != value)
                {
                    _SelectedMatch1 = value;
                    RaisePropertyChanged("SelectedMatch1");
                }
            }
        }
        object _SelectedMatch2;
        public object SelectedMatch2
        {
            get
            {
                return _SelectedMatch2;
            }
            set
            {
                if (_SelectedMatch2 != value)
                {
                    _SelectedMatch2 = value;
                    RaisePropertyChanged("SelectedMatch2");
                }
            }
        }
        object _SelectedMatch3;
        public object SelectedMatch3
        {
            get
            {
                return _SelectedMatch3;
            }
            set
            {
                if (_SelectedMatch3 != value)
                {
                    _SelectedMatch3 = value;
                    RaisePropertyChanged("SelectedMatch3");
                }
            }
        }
        object _SelectedMatch4;
        public object SelectedMatch4
        {
            get
            {
                return _SelectedMatch4;
            }
            set
            {
                if (_SelectedMatch4 != value)
                {
                    _SelectedMatch4 = value;
                    RaisePropertyChanged("SelectedMatch4");
                }
            }
        }
        object _SelectedMatch5;
        public object SelectedMatch5
        {
            get
            {
                return _SelectedMatch5;
            }
            set
            {
                if (_SelectedMatch5 != value)
                {
                    _SelectedMatch5 = value;
                    RaisePropertyChanged("SelectedMatch5");
                }
            }
        }
        object _SelectedMatch6;
        public object SelectedMatch6
        {
            get
            {
                return _SelectedMatch6;
            }
            set
            {
                if (_SelectedMatch6 != value)
                {
                    _SelectedMatch6 = value;
                    RaisePropertyChanged("SelectedMatch6");
                }
            }
        }
        object _SelectedMatch7;
        public object SelectedMatch7
        {
            get
            {
                return _SelectedMatch7;
            }
            set
            {
                if (_SelectedMatch7 != value)
                {
                    _SelectedMatch7 = value;
                    RaisePropertyChanged("SelectedMatch7");
                }
            }
        }
        ...
        public RelayCommand AddBracketMatchCommand { get; set; }
        public RelayCommand RemoveBracketMatchCommand { get; set; }
        ...
        private void InitializeCommands()
        {
            ...
            AddBracketMatchCommand = new RelayCommand(AddBracketMatch);
            RemoveBracketMatchCommand = new RelayCommand(RemoveBracketMatch);
        ...
        private void EditPlayer(object parameter)
        {
            ...
            foreach (Player item in player.Where(x => x.ID == currentPlayer.ID))
            {
                item.FirstName = values[0].ToString();
                item.LastName = values[1].ToString();
                item.Age = int.Parse((string)values[2].ToString());
                item.Salary = double.Parse((string)values[3].ToString());
            }
        }
        ...
        private void AddStaff(object parameter)
        {
            ...
            p.ID = Helpers.FindMaxValue(staff, x => x.ID) + 1;
            p.Name=values[0].ToString();
            p.Age=age;
            p.Salary=salary;
            p.Role = values[3].ToString();
            staff.Add(p);
        }
        ...
        private void EditStaff(object parameter)
        {
            ...
            StaffMember currentStaff = (StaffMember)values[4];
        ...
        #region Bracket
        private void RemoveBracketMatch(object parameter)
        {
            var values = (StaffMember)parameter;
            staff.Remove(values);
        }

        private void AddBracketMatch(object parameter)
        {
        ...
        private void AddRecord(object parameter)
        {
            ...
            Player gracz = (Player)values[2];
            long ownerID = gracz.ID;
